...
QT.global.enabled_features = cross_compile appstore-compliant debug_and_release build_all c++11 c++14 c++1z c99 c11 thread future concurrent signaling_nan simulator_and_device static
...
QT_CONFIG += debug_and_release release debug build_all c++11 c++14 c++1z concurrent no-pkg-config reduce_exports release_tools simulator_and_device static stl
QT_VERSION = 5.14.1
QT_MAJOR_VERSION = 5
QT_MINOR_VERSION = 14
QT_PATCH_VERSION = 1
