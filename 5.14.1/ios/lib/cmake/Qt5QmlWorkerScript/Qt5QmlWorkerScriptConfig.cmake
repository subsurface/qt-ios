        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5QmlWorkerScript_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_QmlWorkerScript_process_prl_file(
            "${_qt5QmlWorkerScript_install_prefix}/lib/libQt5QmlWorkerScript_debug.prl" DEBUG
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "libQt5QmlWorkerScript.a" "" TRUE)



    _populate_QmlWorkerScript_target_properties(DEBUG "libQt5QmlWorkerScript_debug.a" "" TRUE)
