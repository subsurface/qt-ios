        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5QuickShapes_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_QuickShapes_process_prl_file(
            "${_qt5QuickShapes_install_prefix}/lib/libQt5QuickShapes_debug.prl" DEBUG
    ...
    _populate_QuickShapes_target_properties(RELEASE "libQt5QuickShapes.a" "" TRUE)



    _populate_QuickShapes_target_properties(DEBUG "libQt5QuickShapes_debug.a" "" TRUE)
