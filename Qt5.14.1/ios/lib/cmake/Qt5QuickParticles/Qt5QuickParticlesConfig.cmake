        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5QuickParticles_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_QuickParticles_process_prl_file(
            "${_qt5QuickParticles_install_prefix}/lib/libQt5QuickParticles_debug.prl" DEBUG
    ...
    _populate_QuickParticles_target_properties(RELEASE "libQt5QuickParticles.a" "" TRUE)



    _populate_QuickParticles_target_properties(DEBUG "libQt5QuickParticles_debug.a" "" TRUE)
