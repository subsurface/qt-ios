...
set(_Qt5QGeoServiceProviderFactoryMapboxGL_MODULE_DEPENDENCIES "Location;Location;Location;Positioning;Quick;Quick;Quick;Gui;Network;Sql;Core")
...
_qt5_Location_process_prl_file(
    "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_mapboxgl_debug.prl" DEBUG
    _Qt5QGeoServiceProviderFactoryMapboxGL_STATIC_DEBUG_LIB_DEPENDENCIES
    _Qt5QGeoServiceProviderFactoryMapboxGL_STATIC_DEBUG_LINK_FLAGS
)
...
_populate_Location_plugin_properties(QGeoServiceProviderFactoryMapboxGL RELEASE "geoservices/libqtgeoservices_mapboxgl.a" TRUE)
_populate_Location_plugin_properties(QGeoServiceProviderFactoryMapboxGL DEBUG "geoservices/libqtgeoservices_mapboxgl_debug.a" TRUE)
...
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QGeoServiceProviderFactoryMapboxGL,QT_PLUGIN_EXTENDS>,Qt5::Location>,"
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryMapboxGL APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Positioning;Qt5::Quick;Qt5::Quick;Qt5::Quick;Qt5::Gui;Qt5::Network;Qt5::Sql;Qt5::Core"
)
